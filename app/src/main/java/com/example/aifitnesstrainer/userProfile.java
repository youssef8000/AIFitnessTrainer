...
public class userProfile extends Fragment {
    ...
    public void calculateCalorie() {
        ...
        textView1.setText(String.format("%.2f", noExercise) + "*");
        double exercise1 = totalCalories * 1.149;
        textView2.setText(String.format("%.2f", exercise1) + "*");
        double exercise2 = totalCalories * 1.220;
        textView3.setText(String.format("%.2f", exercise2) + "*");
        double exercise3 = totalCalories * 1.292;
        textView4.setText(String.format("%.2f", exercise3) + "*");
        double exercise4 = totalCalories * 1.437;
        textView5.setText(String.format("%.2f", exercise4) + "*");
        double exercise5 = totalCalories * 1.583;
        textView6.setText(String.format("%.2f", exercise5) + "*");
