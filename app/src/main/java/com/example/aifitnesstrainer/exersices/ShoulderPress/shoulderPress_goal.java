...
public class shoulderPress_goal extends Fragment {

    public shoulderPress_goal() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view =inflater.inflate(R.layout.fragment_shoulder_press_goal, container, false);
            ...
            public void onClick(View v) {
                ...
                if (!userGoal.isEmpty() ) {
                    ...
                    if (inserted) {
                        ...
                        Intent intent = new Intent(requireContext(), ShoulderPress_camera.class);
