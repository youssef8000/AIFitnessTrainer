...
public class pushUp_goal extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_push_up_goal, container, false);
        DatabaseHelper databaseHelper = new DatabaseHelper(requireContext());
        TextView name=view.findViewById(R.id.pushUp_name);
        EditText goal=view.findViewById(R.id.set_goal_pushUp);
        Button lateral_raises_camera_start = view.findViewById(R.id.pushUp_camera_start);
            ...
            public void onClick(View v) {
                ...
                if (!userGoal.isEmpty() ) {
                    ...
                    if (inserted) {
                        ...
                        Intent intent = new Intent(requireContext(), pushUp_camera.class);
