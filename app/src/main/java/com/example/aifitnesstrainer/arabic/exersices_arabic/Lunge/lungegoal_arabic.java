...
public class lungegoal_arabic extends Fragment {

    public lungegoal_arabic() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_lungegoal_arabic, container, false);
            ...
            public void onClick(View v) {
                ...
                if (!userGoal.isEmpty() ) {
                    ...
                    if (inserted) {
                        ...
                        Intent intent = new Intent(requireContext(), view_lunge_camera_arabic.class);
