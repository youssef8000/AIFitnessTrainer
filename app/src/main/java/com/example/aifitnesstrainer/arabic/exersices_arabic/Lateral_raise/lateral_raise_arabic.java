...
public class lateral_raise_arabic extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_lateral_raise_arabic, container, false);
        ...
        lateral_raises.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                openFragment(new lateral_raises_goal_arabic());
            }
        });
        return view;
    }
