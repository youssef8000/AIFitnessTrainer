...
import com.example.aifitnesstrainer.homamainFragment;
...
//        homebutton= findViewById(R.id.fab);
        ...
        english.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(MainActivity_arabic.this, MainActivity.class);
        ...
        logoutbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                editor.apply();
                Intent intent = new Intent(MainActivity_arabic.this, Login.class);
                startActivity(intent);
                finish();
            }
        });
