...
import com.example.aifitnesstrainer.arabic.exersices_arabic.squat.squat_view_camera_arabic;
...
public class ShoulderPress_camera_arabic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shoulder_press_camera_arabic);
    ...
    private void startCircularTimer() {
        ...
        new CountDownTimer(5000, 1000) {
            ...
            public void onFinish() {
                ...
                player=MediaPlayer.create(ShoulderPress_camera_arabic.this,R.raw.start_training);
                player.start();
                    ...
                    if (shoulder != null && elbow != null && wrist != null
                        ...
                        if ((seqStateLeft.get(0) == 3 && currentStateLeft == 1 && !complete_exercise
                            ...
                            if (greatesthip_shoulder_LAngle < 170 || greatesthip_shoulder_LAngle < 140) {
                                ...
                                userFeedback_arabic.add("حافظ على كتفيك مستقرة وتجنب الانحناء أو الرفع الزائد.");
                                player=MediaPlayer.create(ShoulderPress_camera_arabic.this,R.raw.incorrect_move);
                                player.start();
                                ...
                                userFeedback_arabic.add("حافظ على مرفقيك قريبة من جسمك ولا تقفلها عند القمة.");
                                player=MediaPlayer.create(ShoulderPress_camera_arabic.this,R.raw.incorrect_move);
                                player.start();
                                ...
                                correct_score++;
                                player=MediaPlayer.create(ShoulderPress_camera_arabic.this,R.raw.correct_move);
                                player.start();
                            }
                        ...
                        if(current_score==goal && !feedbackSpoken){
                            player=MediaPlayer.create(ShoulderPress_camera_arabic.this,R.raw.check_feedback);
                            player.start();
                            feedbackSpoken = true;
                            ...
                            if (inserted) {
                                Toast.makeText(ShoulderPress_camera_arabic.this, "تستطيع أن ترى ملاحظتنا على التمرين.", Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(ShoulderPress_camera_arabic.this, "Failed Inserted", Toast.LENGTH_SHORT).show();
                            }
                        ...
                        if (elbow_angleL < 155 && elbow_angleL > 140 ) {
                            ...
                            ErrorelbowLMessage.setText("تجنب ثني المرفق بشكل مفرط");
                        } else if (elbow_angleL < 80 ) {
                            ErrorelbowLMessage.setText("");
                            drawErrorLineBetweenLandmarks(wrist, elbow);
                            ErrorelbowLMessage.setText("زيادة ثني المرفق");
                        } else {
                            drawLineBetweenLandmarks(wrist, elbow);
                            ErrorelbowLMessage.setText("");
                        }
                        ...
                        if (elbow_angleR < 155 && elbow_angleR > 140) {
                            ...
                            ErrorelbowRMessage.setText("تجنب ثني المرفق بشكل مفرط");
                        } else if ( elbow_angleR < 80 ) {
                            ErrorelbowRMessage.setText("");
                            drawErrorLineBetweenLandmarks(wristr, elbowr);
                            ErrorelbowRMessage.setText("زيادة ثني المرفق");
                        } else {
                            drawLineBetweenLandmarks(wristr, elbowr);
                            ErrorelbowRMessage.setText("");
                        }
                        ...
                        if (shoulderl < 170 && shoulderl > 150) {
                            ...
                            ErrorShoulderLMessage.setText("تجنب ثني زائد للكتف");
                        } else if ( shoulderl < 135 && shoulderl > 50 ) {
                            ErrorShoulderLMessage.setText("");
                            drawErrorLineBetweenLandmarks(elbow, shoulder);
                            ErrorShoulderLMessage.setText("زيادة ثني الكتف");
                        } else {
                            drawLineBetweenLandmarks(elbow, shoulder);
                            ErrorShoulderLMessage.setText("");
                        }
                        ...
                        if (shoulderR < 170 && shoulderR > 150 ) {
                            ...
                            ErrorShoulderRMessage.setText("تجنب ثني زائد للكتف");
                        } else if ( shoulderR < 135 && shoulderR > 50 ) {
                            ErrorShoulderRMessage.setText("");
                            drawErrorLineBetweenLandmarks(elbowr, shoulderr);
                            ErrorShoulderRMessage.setText("زيادة ثني الكتف");
                        } else {
                            drawLineBetweenLandmarks(elbowr, shoulderr);
                            ErrorShoulderRMessage.setText("");
                        }
                        ...
                        errormessage.setText("بعض العلامات المميزة غير موجودة لاكتشاف الShoulder Press بشكل صحيح");
                    }
