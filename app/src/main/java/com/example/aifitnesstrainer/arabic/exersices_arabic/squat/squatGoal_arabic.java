...
public class squatGoal_arabic extends Fragment {


    public squatGoal_arabic() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_squat_goal_arabic, container, false);
            ...
            public void onClick(View v) {
                ...
                if (!userGoal.isEmpty() ) {
                    ...
                    if (inserted) {
                        ...
                        Intent intent = new Intent(requireContext(), squat_view_camera_arabic.class);
