...
public class lateral_raises_goal_arabic extends Fragment {


    public lateral_raises_goal_arabic() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_lateral_raises_goal_arabic, container, false);
        DatabaseHelper databaseHelper = new DatabaseHelper(requireContext());
        TextView name=view.findViewById(R.id.lateral_raises_name);
        EditText goal=view.findViewById(R.id.set_goal_lateral_raises);
        Button lateral_raises_camera_start = view.findViewById(R.id.lateral_raises_camera_start);
            ...
            public void onClick(View v) {
                ...
                if (!userGoal.isEmpty() ) {
                    ...
                    if (inserted) {
                        ...
                        Intent intent = new Intent(requireContext(), view_LateralRaise_camera_arabic.class);
