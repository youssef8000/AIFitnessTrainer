...
public class squat_view_camera_arabic extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_squat_view_camera_arabic);
    ...
    private void startCircularTimer() {
        ...
        new CountDownTimer(5000, 1000) {
            ...
            public void onFinish() {
                ...
                player=MediaPlayer.create(squat_view_camera_arabic.this,R.raw.start_training);
                player.start();
//                speak.speak("Let's start training",TextToSpeech.QUEUE_FLUSH,null);
            ...
            public void analyze(@NonNull ImageProxy imageProxy) {
                ...
                if (poseArrayList.size() >= 1) {
                    ...
                    if (hipr != null && kneer != null && ankler != null && shoulderr != null && wristr != null
                        ...
                        if (nosey>35)
                        {
                            nosemessage.setText("الكاميرا غير محاذاة بشكل صحيح، يرجى الوقوف على الجانب الأيمن من الكاميرا.");
                        }else {
                            nosemessage.setText("");
                        }
                        ...
                        if(current_score==goal && !feedbackSpoken){
                            ...
                            player=MediaPlayer.create(squat_view_camera_arabic.this,R.raw.check_feedback);
                            player.start();
                            feedbackSpoken = true;
                            ...
                            if (inserted) {
                                Toast.makeText(squat_view_camera_arabic.this, "تستطيع أن ترى ملاحظتنا على التمرين.", Toast.LENGTH_SHORT).show();
                                ...
                                Toast.makeText(squat_view_camera_arabic.this, "Failed Inserted", Toast.LENGTH_SHORT).show();
                            }
                        }
                        ...
                        errormessage.setText("بعض العلامات المميزة غير موجودة لاكتشاف الSquat بشكل صحيح");
                    }
    ...
    private void DetectMovement(int roundedKneeFlexionAngle, int roundedHipFlexionAngle, int roundedAnkleDorsiflexionAngle,
        ...
        if (roundedKneeFlexionAngle > 95) {
            ErrorKneeMessage.setText("الجلوس بشكل عميق");
        ...
        if (roundedAnkleDorsiflexionAngle > 40) {
            ErrorAnkleMessage.setText("الركبة تتجاوز الأصبع الكبير");
...
//                speak.speak("This is an incorrect move because your hip is higher than your knee", TextToSpeech.QUEUE_FLUSH, null);
                ...
                userFeedback_arabic.add("أنت تنحني للأمام.");
                player=MediaPlayer.create(squat_view_camera_arabic.this,R.raw.incorrect_move);
                player.start();
            } else if (greatestHipAngle < 20 && greatestHipAngle > 10) {
                incorrect_score++;
                userFeedback.add("You are bending backward.");
                userFeedback_arabic.add("أنت تنحني للخلف.");
                player=MediaPlayer.create(squat_view_camera_arabic.this,R.raw.incorrect_move);
                player.start();
            } else if (greatestAnkleAngle > 40) {
                incorrect_score++;
                userFeedback.add("Your knee is falling over your toe.");
                userFeedback_arabic.add("ركبتك تتجاوز أصابع قدمك الكبيرة.");
                player=MediaPlayer.create(squat_view_camera_arabic.this,R.raw.incorrect_move);
                player.start();
            } else {
                correct_score++;
                player=MediaPlayer.create(squat_view_camera_arabic.this,R.raw.correct_move);
                player.start();
            }
